...
class DealFinderGUI:
    ...
    def __init__(self, root):
        ...
        self.max_results_label = ttk.Label(self.options_frame, text="Max results per website:")
        ...
        self.save_results_checkbox = ttk.Checkbutton(self.options_frame, text="Save results to file", variable=self.save_results_var)
        ...
        self.output_text = scrolledtext.ScrolledText(self.output_frame, wrap=tk.WORD, state="disabled")
        ...
        self.results_tree = ttk.Treeview(self.results_frame, columns=("price", "website"), show="headings")
        ...
        self.results_tree.column("website", width=100)
